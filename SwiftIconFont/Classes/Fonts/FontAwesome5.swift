...
public let fontAwesome5IconArr: [String: String] = [
    ...
    "columns": "\u{f0db}",
    "comment": "\u{f075}",    "comment-alt": "\u{f27a}",
    ...
    "handshake-alt-slash": "\u{f95f}",

    "handshake-slash": "\u{f960}",
    ...
    "head-side-cough": "\u{f961}",

    "head-side-cough-slash": "\u{f962}",

    "head-side-mask": "\u{f963}",

    "head-side-virus": "\u{f964}",
