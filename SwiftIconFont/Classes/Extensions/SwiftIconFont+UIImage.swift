...
public extension UIImage
{
    public convenience init(from font: Fonts, code: String, textColor: UIColor = .black, backgroundColor: UIColor = .clear, size: CGSize) {
        ...
        let attributes = [NSAttributedStringKey.font: UIFont.icon(from: font, ofSize: fontSize), NSAttributedStringKey.foregroundColor: textColor, NSAttributedStringKey.backgroundColor: backgroundColor, NSAttributedStringKey.paragraphStyle: paragraphStyle]
